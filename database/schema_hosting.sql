...
-- Database Schema kwa HOSTING ZA BURE (InfinityFree na wengine)
-- Faili hii HAINA amri za "CREATE DATABASE" kwa sababu hosting
-- za bure hazikuruhusu kuunda database mpya kwa SQL — database
-- inatakiwa iwe imeshaundwa kwenye Control Panel kabla.
--
-- JINSI YA KUTUMIA: Fungua phpMyAdmin, CHAGUA database yako
-- (mfano if0_42662929_freshscents) upande wa kushoto KWANZA,
-- kisha bofya Import, chagua faili hii, bofya Go.
--
-- MUHIMU: Hii ni kwa AJILI YA KUANZISHA DATABASE MPYA TU
-- (mradi mpya kabisa, database tupu). Kama tayari una database
-- yenye majedwali (kama ile ya sasa ya freshscents), USITUMIE
-- faili hii — badala yake tumia faili za "migrate_*.sql"
-- ulizopewa awali (mfano migrate_variants.sql, migrate_pos.sql).
-- =========================================================
